...
export const NEUTRAL_CARDS: CardDef[] = [
  ...
  unit(F, 'ne_gaunter_odimm', "Gaunter O'Dimm", 2, ['siege'], { abilities: ['muster'], musterGroup: 'odimm' }),
  unit(F, 'ne_gaunter_darkness', "Gaunter O'Dimm: Darkness", 4, ['ranged'], { abilities: ['muster'], musterGroup: 'odimm', count: 3 }),
